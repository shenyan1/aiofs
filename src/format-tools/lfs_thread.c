...
void mutex_enter(pthread_mutex_t *mp,const char *str){
...
void mutex_exit(pthread_mutex_t *mp,const char *str){
...
void lfs_rw_enter(pthread_rwlock_t *lock,int rw){


}

inline void cv_wait(pthread_cond_t *cv,pthread_mutex_t *lock){
