...
struct object *
sarc_getobj (struct __sarc_object *e)
{
...
static int
__op_fetch (struct __sarc_object *e)
{
    int ret;
    uint64_t offset, id;
    struct object *obj = __arc_list_entry (e, struct object, entry);
...
static void
__op_evict (struct __sarc_object *e)
{
    struct object *obj = __arc_list_entry (e, struct object, entry);
...
static void
__op_destroy (struct __sarc_object *e)
{
    struct object *obj = __arc_list_entry (e, struct object, entry);
//              free(obj->data);
 ...
 */
int
sarc_file_read (int id, char *buffer, uint32_t size, uint64_t offset)
{
