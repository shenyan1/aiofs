...
static int __op_compare(struct __sarc_object *e, uint64_t id,uint64_t offset)
{
 ...
 */
static inline int  __op_prefetch_disk(uint64_t id,uint64_t offset,struct __sarc_object *e){
	int i;	
 ...
 */
static inline int  __op_fetch_disk(uint64_t id,uint64_t offset,struct __sarc_object *e){
	int i;	
	struct object *obj=sarc_getobj(e);
